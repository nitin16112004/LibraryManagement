...
class TestStudent(unittest.TestCase):
    ...
    def test_get_student_info(self):
        ...
        expected_info = "Student ID: 1, First Name: John, Last Name: Doe, Email: john.doe@example.com, Phone No: 1234567890"
        self.assertEqual(self.student.GetStudentInfo(), expected_info)

    def test_update_details(self):
        """Test the UpdateDetails method."""
        update_message = self.student.UpdateDetails(firstName="Jane", email="jane.doe@example.com")
        ...
        self.assertEqual(self.student.LastName, "Doe")  # Ensure other details are unchanged

    def test_string_representation(self):
        """Test the __str__ method."""
        expected_str = "Student ID: 1, First Name: John, Last Name: Doe, Email: john.doe@example.com, Phone No: 1234567890"
    ...
    def test_partial_update(self):
        ...
        self.assertEqual(self.student.FirstName, "John")  # Ensure other details are unchanged
